...
description_short = 'Python based tool for displaying power consumption data from a remote mysql database'
...
about = """
        ...
        * Shows an overview of power consumption from from data stored on a remote mysql database.
